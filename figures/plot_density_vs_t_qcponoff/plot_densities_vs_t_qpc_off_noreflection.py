...
def plot_densities(file, W = 1, tmin =0, tmax = 500,imin =10, imax = 1400, fac = 1e7, M =1, title ='') :
    times , charge_density = pickle.load(open(file, 'rb'))
...
files = glob.glob('*V03*')
plot_densities(files[0], W =1, tmin =1000, tmax = 15000,imax = 2200, fac = 6e6, M =1, title ='') 
plt.savefig('plot_density_vs_t_qpc_off_noreflection.pdf', format = 'pdf', dpi = 60)
